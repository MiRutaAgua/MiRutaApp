...
public class MyCounterPortal implements Comparable<MyCounterPortal>  {
    ...
    @Override
    public int compareTo(MyCounterPortal o) {
        if (getDireccion() == null || o.getDireccion() == null)
            return 0;
        return getDireccion().compareTo(o.getDireccion());
    }
}
